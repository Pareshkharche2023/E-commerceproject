...
{  
    public static void main(String args[])   
        {  
            ...
            System.out.println("\t\t\t\t\t    Shivaji Nagar Pune");  
            System.out.println("\t\t\t\t\t"  +"    " +"Near Railystation");  
            System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 11208965656");  
            ...
            //here I create Scanner class object  
            
            //here I create an ArrayList to store the products  
